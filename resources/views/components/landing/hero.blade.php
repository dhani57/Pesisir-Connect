                    ...
                    <div class="flex flex-col sm:flex-row gap-2 sm:gap-0">
                        ...
                        <div class="flex-1 flex items-center gap-3 px-4 py-2 sm:py-0">
                            ...
                            <input type="text"
                                   ...
                                   class="w-full border-0 bg-transparent text-sm text-gray-700 placeholder-gray-400 focus:ring-0 focus:outline-none py-1.5"
                                   id="hero-search-input">
                        </div>

                        {{-- Location Select --}}
                        <div class="flex items-center gap-3 px-4 py-2 sm:py-0 sm:border-l border-gray-200 relative min-w-[160px] shrink-0">
                            ...
                            <select name="location"
                                    x-model="location"
                                    class="w-full border-0 bg-transparent text-sm text-gray-700 focus:ring-0 focus:outline-none py-1.5 pr-8 appearance-none cursor-pointer !bg-none relative z-10"
                            ...
                            <svg class="w-4 h-4 text-gray-400 absolute right-4 pointer-events-none z-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7"/></svg>
                        </div>
