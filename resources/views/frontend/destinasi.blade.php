...
<body class="antialiased">
    ...
    <nav class="fixed top-0 inset-x-0 z-50 bg-white/95 backdrop-blur-xl shadow-md transition-all duration-300" id="destinasi-navbar">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <div class="hidden md:flex items-center gap-1">
                    ...
                    <a href="{{ route('destinasi') }}" class="px-4 py-2 rounded-xl text-sm font-medium text-ocean-600 bg-ocean-50 transition-colors">Destinasi</a>
                    <a href="{{ route('tentang') }}" class="px-4 py-2 rounded-xl text-sm font-medium text-gray-700 hover:text-ocean-600 transition-colors">Tentang</a>
                </div>
