...
<body class="antialiased">
    ...
    {{-- Navbar --}}
    <nav class="fixed top-0 inset-x-0 z-50 bg-white/95 backdrop-blur-xl shadow-md transition-all duration-300" id="tentang-navbar">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 md:h-20">
                ...
                <div class="hidden md:flex items-center gap-1">
                    ...
                    <a href="{{ route('catalog') }}" class="px-4 py-2 rounded-xl text-sm font-medium text-gray-700 hover:text-ocean-600 transition-colors">Katalog</a>
                    <a href="{{ route('destinasi') }}" class="px-4 py-2 rounded-xl text-sm font-medium text-gray-700 hover:text-ocean-600 transition-colors">Destinasi</a>
                    <a href="{{ route('tentang') }}" class="px-4 py-2 rounded-xl text-sm font-medium text-ocean-600 bg-ocean-50 transition-colors">Tentang</a>
                </div>
        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="bg-gradient-to-br from-ocean-50 to-ocean-100/50 rounded-3xl p-8 sm:p-12 md:p-16 border border-ocean-100">
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <a href="{{ route('catalog') }}" class="btn-outline !py-3.5 !px-8">
                        Jelajahi Katalog
                    </a>
                </div>
            </div>
